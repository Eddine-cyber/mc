...
from mcmc_sabr_2.mcmc_mala_beta_fixed_2 import MCMCMalaBetaFixed
...
def main():
    ...
    plot_smiles_distribution(sampler, samples, f, maturity, strikes, strike_percentages, market_vols, 'All maturities')
