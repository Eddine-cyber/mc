...
from mcmc_sabr_2.mcmc_base_2 import MCMCBase
import mcmc_sabr.config as config
from mcmc_sabr.utils import _transform_4_params, _inverse_transform_4_params, _jacobian_det_4_params
...
class MCMCVectorized(MCMCBase):
    ...
    def get_one_param_jacobian_func(self, param_idx):
        """
        Retourne une fonction vectorisée pour le Jacobien d'une seule transformation de paramètre.
        Toutes les fonctions sont déjà vectorisées par NumPy.
        """
